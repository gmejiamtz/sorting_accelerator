module bitonic_sorter_third_stage (
    input clk_i,
    input resetn_i,
    ...
    logic [1:0] valid_l;    //clog2(pe_count)
    logic [1:0] descend_1_l;
    logic [1:0] descend_2_l;
    logic [1:0] descend_3_l;
    logic [1:0] descend_4_l;

    for(genvar i = 0; i < 16; i=8+i) begin : bitonic_sorter_merger_8_elem_genloop
        bitonic_sorter_merger_8_elem third_stage_sorter (
            .clk_i(clk_i),
            .resetn_i(resetn_i),
