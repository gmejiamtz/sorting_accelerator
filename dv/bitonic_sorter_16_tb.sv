...
initial begin
    $dumpfile( "bitonic_sorter_16.fst" );
    $dumpvars;
    $display("Beginning Bitonc Sorter 16 Simulation");
    reset();
...
final begin
    $display("Summarizing Bitonc Sorter 16 Simulation");
    if(errors) begin
